...
const LikeIcon = ({ onClick, isLiked }) => {
  return(
    <svg width="24" height="24" viewBox="0 0 24 24" fill={isLiked ? "#FF529A" : "#AFB1B6"} xmlns="http://www.w3.org/2000/svg" onClick={onClick}>
      ...
      <path fill-rule="evenodd" clip-rule="evenodd" d="M18.1537 10.6249C17.7667 10.6249 17.4387 10.3279 17.4067 9.9359C17.3407 9.1139 16.7907 8.4199 16.0077 8.1669C15.6127 8.0389 15.3967 7.6159 15.5237 7.2229C15.6527 6.8289 16.0717 6.6149 16.4677 6.7389C17.8307 7.1799 18.7857 8.3869 18.9027 9.8139C18.9357 10.2269 18.6287 10.5889 18.2157 10.6219C18.1947 10.6239 18.1747 10.6249 18.1537 10.6249Z"/>
    </svg>
...
const BookCard = ({ book, onLike, likedBooks }) => {
