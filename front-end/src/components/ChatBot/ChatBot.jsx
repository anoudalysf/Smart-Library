...
const ChatBot = ({ onSend }) => {
  ...
  const [responses, setResponses] = useState([]); // for chat history
  ...
  return (
    <div>
      ...
      <svg width="45" height="45" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <mask id="mask0_1_1875" style={{"mask-type":"luminance"}} maskUnits="userSpaceOnUse" x="1" y="1" width="22" height="22">
            ...
            <path fill-rule="evenodd" clip-rule="evenodd" d="M15.6963 13.163C15.1443 13.163 14.6923 12.716 14.6923 12.163C14.6923 11.61 15.1353 11.163 15.6873 11.163H15.6963C16.2483 11.163 16.6963 11.61 16.6963 12.163C16.6963 12.716 16.2483 13.163 15.6963 13.163Z" fill="white"/>
            <path fill-rule="evenodd" clip-rule="evenodd" d="M11.6875 13.163C11.1355 13.163 10.6835 12.716 10.6835 12.163C10.6835 11.61 11.1255 11.163 11.6785 11.163H11.6875C12.2395 11.163 12.6875 11.61 12.6875 12.163C12.6875 12.716 12.2395 13.163 11.6875 13.163Z" fill="white"/>
            <path fill-rule="evenodd" clip-rule="evenodd" d="M7.67832 13.163C7.12632 13.163 6.67432 12.716 6.67432 12.163C6.67432 11.61 7.11732 11.163 7.66932 11.163H7.67832C8.23032 11.163 8.67832 11.61 8.67832 12.163C8.67832 12.716 8.23032 13.163 7.67832 13.163Z" fill="white"/>
        </svg>
